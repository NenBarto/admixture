...
results<-list()
for(i in minK:maxK){
  data<-read.table(paste0(prefix,"/results_fs_canids9/fS_run_K.",i,".meanQ"))
...
dataM<-totalResults[["fastStructure"]]
...
pdf(paste0("figures/",prefix,"_fastStructure_K3-7.pdf"),width=30,height=20)
